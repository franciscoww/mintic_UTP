...
def agregarProducto(db:dict)->dict:
    ...
    marcas = ['Pepsi', 'Acer', 'Pietran', 'LG', 'Otro']
...
def borrarProducto (db:dict)->None:
    print('Borrar producto: ')
    productos = list(db.keys())
    msj = '\nIngrese el nombre del producto a eliminar: '
    prodBorrar = verificarElemento(productos, msj)
    borrar=db.pop(prodBorrar)
    print(f'\nSe ha eliminado correctamente del inventario: {prodBorrar}\n')
